...
Patterns of space use (utilisation distributions) can be reconstructed using standard statistical techniques (see `map_pou()` and `map_dens()` for inbuilt functions).
