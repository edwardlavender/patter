...
Patterns of space use (utilisation distributions) can be reconstructed using standard statistical techniques (see `pf_map_pou()` and `pf_map_dens()` for inbuilt functions).
