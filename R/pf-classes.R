...
#'
#' The weights column (`weight`) is equal to the `lik` column, for particles generated by stochastic kicks, or the product of the `lik` and `dens` columns, in the case of directed sampling (see below), but normalised to sum to one across particles.
#'
