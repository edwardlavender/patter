...
#' @param .backward (optional) If .`forward` contains particle samples from the forward run, `.backward` can contain particle samples from a backward simulation, provided in any format accepted by [`.pf_history_list()`]. The `cell_now` column is required.
