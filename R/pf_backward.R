...
#' * `pf_backward_sampler_*()` are backward sampling routines. This algorithm samples from the joint distribution of particles, given all of the data---both from the past and the future. This is much more expensive. Currently there are two imlpementation options:
