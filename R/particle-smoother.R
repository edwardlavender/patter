...
#'
#' * `.map` is a [`terra::SpatRaster`] that defines the study area of the simulation (see [`pf_filter()`]). On Linux with `JuliaCall`, this argument can generally only be used safely if `JULIA_SESSION = "FALSE"`.
