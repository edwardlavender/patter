...
**Particle filters, smoothers and sampling algorithms for animal movement modelling in [`Julia`](https://julialang.org)**
...
* **`two_filter_smoother()`** is a particle smoothing algorithm. At each time step, the smoother accounts for all of the data from both the past _and_ the future (the full marginal distribution) and substantially refines maps of space use. 
